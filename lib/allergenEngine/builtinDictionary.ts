...
export const BUILTIN_ALLERGENS: BuiltinAllergen[] = [
  ...
  },
  {
    ...
    synonyms: [
      ...
      // German legal names / compounds (no whole-word hazelnut, almond, walnut, nuts)
      'haselnuss', 'haselnüsse', 'haselnusse', 'haselnuesse',
      'haselnusskerne', 'haselnusskern',
      'haselnusscreme', 'haselnussmus', 'haselnusspaste', 'haselnussöl',
      'mandel', 'mandeln',
      'mandelkerne', 'mandelkern',
      'mandelmilch', 'mandelmehl', 'mandelöl', 'mandelmus', 'mandelpaste',
      'walnuss', 'walnüsse', 'walnusse', 'walnuesse',
      'walnusskerne', 'walnusskern', 'walnussöl',
      'cashewkerne', 'cashewkern', 'cashewnuss', 'cashewnüsse', 'cashewnusse',
      'pistazie', 'pistazien',
      'paranuss', 'paranüsse', 'paranusse',
      'pekannuss', 'pekannüsse', 'pekannusse',
      'pinienkerne', 'pinienkern',
      'macadamianuss', 'macadamianüsse', 'macadamianusse',
      'schalenfrüchte', 'schalenfruchte', 'schalenfruechte',
      'nüsse', 'nusse',
    ],
  },
  {
