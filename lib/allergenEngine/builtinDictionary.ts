...
export const CELIAC_RULES = {
  ...
  ALLERGEN_SECTION: {
    terms: ['contains wheat', 'contains gluten', 'contains barley', 'contains rye'],
    severity: 'AVOID' as const,
    signalType: 'ALLERGEN_SECTION' as const,
    reason: 'Product explicitly declares gluten source',
  },
  AMBIGUOUS_MALT: {
    terms: ['malt extract', 'malt flavor', 'malt syrup', 'malt'],
  ...
  OATS: {
    terms: ['oats', 'oat flour', 'oat bran', 'rolled oats', 'oat fiber', 'oatmeal'],
    severity: 'CAUTION' as const,
