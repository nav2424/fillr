...
function baseScan(overrides: Partial<ScanResult> = {}): ScanResult {
  return {
    ...
    smartSummary: '',
    ingredientBreakdown: [
      { name: 'Whole grain rolled oats', ingredientRating: 'clean', whatItIs: '', whyItsUsed: '', whatToKnow: '' },
      { name: 'Sugar', ingredientRating: 'okay', whatItIs: '', whyItsUsed: '', whatToKnow: '' },
      { name: 'Salt', ingredientRating: 'okay', whatItIs: '', whyItsUsed: '', whatToKnow: '' },
    ],
    insights: [],
    scoringData: {
