...
export const INGREDIENT_GENERIC_PROSE_PATTERNS: RegExp[] = [
  ...
  /is included in this product/i,
  /can affect texture, flavor, or nutrition depending on the formula/i,
  /can affect texture, flavour, or nutrition depending on the formula/i,
  /\b(included in (this|the) product|listed on this product)\b/i,
